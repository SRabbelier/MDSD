...
public class EntityParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Entity");
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityParseController.class);
    }
  ...
  { 
    return EntityParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
