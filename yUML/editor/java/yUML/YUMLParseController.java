...
public class YUMLParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("YUML");
  ...
  { 
    try
    { 
      InputStream descriptorStream = YUMLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = YUMLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(YUMLParseController.class);
    }
  ...
  { 
    return YUMLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
