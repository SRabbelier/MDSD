...
public class DiagramParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Diagram");
  ...
  { 
    try
    { 
      InputStream descriptorStream = DiagramParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DiagramParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DiagramParseController.class);
    }
  ...
  { 
    return DiagramParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
