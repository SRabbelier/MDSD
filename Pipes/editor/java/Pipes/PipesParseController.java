...
public class PipesParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Pipes");
  ...
  { 
    try
    { 
      InputStream descriptorStream = PipesParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = PipesParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(PipesParseController.class);
    }
  ...
  { 
    return PipesParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
